...
function pepark() {
  return (
    ...
    <img  className="hospimg" src='images/img-h4.jpg'/>
   ...
   <div className='hmain1-container'> 
    ...
    <div className='desc'>
    pepark Hotels is one of the most luxurious & prominent hotels in Mumbai. It is located at 
      a very prime location in Manali. The hotel is just 3 km away from Mall Road, therefore; it will 
      ...
      In addition,
       ...
       You can glance
        at beautiful views from the room to enjoy the beauty of Mumbai. Moreover, there is enough space 
        in the balconies
      ...
      of different cuisines. At pepark, we intend to make each of our guest’s stay the best.</div></div>
   <div className='det'>
     Place :Mumbai<br/>
     contact :040-20209876<br/>
     price :15000/- per day<br/>
     <Link to='/payment' >
