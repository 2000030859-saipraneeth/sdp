...
function kartav() {
  return (
    <div className='hmain-container'>
      ...
      <img className="hospimg" src='images/img-h7.jfif'/>
     ...
     <div className='hmain1-container'> 
      ...
      <div className='desc'>
      Kartav Hotels is one of the most luxurious & prominent hotels in Karnataka. It is located at 
        a very prime location in Karnataka. The hotel is just 3 km away from Mall Road, therefore; it will 
        ...
        In addition,
         ...
         You can glance
          at beautiful views from the room to enjoy the beauty of Karnataka. Moreover, there is enough space 
          in the balconies
        ...
        of different cuisines. At Kartav, we intend to make each of our guest’s stay the best.</div></div>
     <div className='det'>
       Place :Karnataka<br/>
       contact :040-20209876<br/>
       price :12000/- per day<br/>
       <Link to='/payment' >
