...
function vistara() {
  return (
    ...
    <div className='hmain-container'>
      ...
      <img className="hospimg" src='images/img-h1.jpg'/>
     ...
     <div className='hmain1-container'> 
      ...
      <div className='desc'>
      Vistara Hotels is one of the most luxurious & prominent hotels in Manali. It is located at 
        ...
        In addition,
         ...
         You can glance
          at beautiful views from the room to enjoy the beauty of Manali. Moreover, there is enough space 
          in the balconies
