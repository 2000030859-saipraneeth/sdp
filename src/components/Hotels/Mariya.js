...
function Mariya() {
  return (
    <div className='hmain-container'>
      ...
      <img className="hospimg" src='images/img-h9.jfif'/>
     ...
     <div className='hmain1-container'> 
      ...
      <div className='desc'>
      Mariya Hotels is one of the most luxurious & prominent hotels in kashmir. It is located at 
        a very prime location in Kashmir. The hotel is just 3 km away from Mall Road, therefore; it will 
        ...
        In addition,
         ...
         You can glance
          at beautiful views from the room to enjoy the beauty of Mariya. Moreover, there is enough space 
          in the balconies
        ...
        of different cuisines. At Mariya, we intend to make each of our guest’s stay the best.</div></div>
     <div className='det'>
       Place :Kashmir<br/>
