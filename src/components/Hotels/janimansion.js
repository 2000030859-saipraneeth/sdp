...
function janimansion() {
  return (
    <div className='hmain-container'>
      ...
      <img className="hospimg" src='images/img-h5.png'/>
     ...
     <div className='hmain1-container'> 
      ...
      <div className='desc'>
      Janimansion Hotels is one of the most luxurious & prominent hotels in jaypur. It is located at 
        a very prime location in jaypur. The hotel is just 3 km away from Mall Road, therefore; it will 
        ...
        In addition,
         ...
         You can glance
          at beautiful views from the room to enjoy the beauty of jaypur. Moreover, there is enough space 
          in the balconies
        ...
        of different cuisines. At Janimansion, we intend to make each of our guest’s stay the best.</div></div>
     <div className='det'>
       Place :Jaipur<br/>
