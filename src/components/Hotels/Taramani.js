...
function Taramani() {
  return (
    <div className='hmain-container'>
      ...
      <img className="hospimg" src='images/img-h3.jfif'/>
     ...
     <div className='hmain1-container'> 
      ...
      <div className='desc'>
      Taramani Hotels is one of the most luxurious & prominent hotels in chennai. It is located at 
        a very prime location in chennai. The hotel is just 3 km away from Mall Road, therefore; it will 
        ...
        In addition,
         ...
         You can glance
          at beautiful views from the room to enjoy the beauty of chennai. Moreover, there is enough space 
          in the balconies
        ...
        of different cuisines. At Taramani, we intend to make each of our guest’s stay the best.</div></div>
     <div className='det'>
       Place :Chennai<br/>
